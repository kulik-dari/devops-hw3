resource "aws_db_subnet_group" "this" {
  ...
  tags = { Name = "${var.identifier}-subnet-group", ManagedBy = "Terraform" }
}
...
resource "aws_security_group" "this" {
  ...
  tags = { Name = "${var.identifier}-sg", ManagedBy = "Terraform" }
}
...
resource "aws_db_parameter_group" "this" {
  ...
  tags = { Name = "${var.identifier}-params", ManagedBy = "Terraform" }
}
...
resource "aws_rds_cluster_parameter_group" "this" {
  ...
  tags = { Name = "${var.identifier}-cluster-params", ManagedBy = "Terraform" }
}
...
locals {
  ...
  parameter_group_family = local.is_postgres ? (var.use_aurora ? "aurora-postgresql15" : "postgres15") : (var.use_aurora ? "aurora-mysql8.0" : "mysql8.0")
}
